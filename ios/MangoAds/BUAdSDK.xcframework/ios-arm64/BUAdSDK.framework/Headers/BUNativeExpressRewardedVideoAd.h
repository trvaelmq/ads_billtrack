...
typedef void(^BUNativeExpressRewardedAgainConfiguration)(BURewardedVideoModel * _Nullable rewardedAgainVideoModel);
...
/**
 *  This method is called when play again, you can return a configuration about play again.
 *
 */
