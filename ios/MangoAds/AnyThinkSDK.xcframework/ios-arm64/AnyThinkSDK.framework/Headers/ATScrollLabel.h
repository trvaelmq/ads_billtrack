...
typedef NS_ENUM(NSUInteger, ATScrollLabelAlignment) {
    ATScrollLabelAlignmentLeft = 0,
    ATScrollLabelAlignmentCenter,
    ATScrollLabelAlignmentRight
};
...
@property (nonatomic, assign) ATScrollLabelAlignment labelAlignment;     //当文字长度未超过Frame宽度时的对齐方式：左，中，右。默认为居中对齐。
