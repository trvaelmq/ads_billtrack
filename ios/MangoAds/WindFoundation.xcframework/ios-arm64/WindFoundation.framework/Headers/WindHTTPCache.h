...
/**
 *  WindHTTPCache is a smart media cache framework.
 */
@interface WindHTTPCache : NSObject
 ...
 */
+ (WindHCDataReader *)cacheReaderWithRequest:(WindHCDataRequest *)request;
 ...
 */
+ (WindHCDataLoader *)cacheLoaderWithRequest:(WindHCDataRequest *)request;
 ...
 */
+ (WindHCDataCacheItem *)cacheCacheItemWithURL:(NSURL *)URL;
 ...
 */
+ (NSArray<WindHCDataCacheItem *> *)cacheAllCacheItems;
